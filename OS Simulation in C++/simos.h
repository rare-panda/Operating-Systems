...
#include <strings.h>
//#define Debug 1
int cpuDebug, memDebug, termDebug, swapDebug, clockDebug, uiDebug, submitDebug;
FILE *bugF, *infF;
...
#define submitInterrupt 16  // before setting endIO, caller should add the pid to endIO list
